...
class ImportedProducts extends StatefulWidget {
  const ImportedProducts({Key? key}) : super(key: key);
  static const pageName = 'Used Products';
  @override
  _ImportedProductsState createState() => _ImportedProductsState();
}

class _ImportedProductsState extends State<ImportedProducts> {
  var productList = [
    Product(
      name: 'Ford KA4 USA',
